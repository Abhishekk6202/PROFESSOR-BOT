...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("Gʀᴏᴜᴘ ✮", url="https://t.me/ABHiiGroup"), 
            InlineKeyboardButton("Cʜᴀɴɴᴇʟ ✯", url="https://t.me/Movilious")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ', url='https://t.me/+ey8Q38ShP4ZjYzll')
            ],[
